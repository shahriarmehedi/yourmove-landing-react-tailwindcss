...
const AppFeatures = () => {
    return (
        <div className='mt-20 mb-20'>
            ...
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-20  py-10'>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-5'>
                    <div className='p-7 border-[1px] rounded-lg border-gray-300'>
                        ...
                        <p className='py-4 text-gray-400'>
                            We use AI to generate the best possible conversation starters for you so that you can get the conversation going.
                        </p>
                    </div>
                    <div className='p-7 border-[1px] rounded-lg border-gray-300'>
                        <div className=''>
