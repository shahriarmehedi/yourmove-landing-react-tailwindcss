        ...
        <div className='bg-gray-800 mt-10 relative'>
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-20 flex flex-col lg:flex-row  items-center py-20 gap-36'>
                ...
                <div>
                    ...
                    <div className=''>
                        <div className='bg-gray-700 bg-opacity-20 text-gray-400 rounded-xl py-7 px-10 mt-7'>
                            <span>
                                {/* conversation svg */}
                        ...
                        ">
                            ...
                            <div className='flex justify-end'>
                                <button className='bg-sky-500 mt-5 text-white px-10 py-[12px] rounded-md text-sm font-semibold hover:bg-sky-600 transition duration-200'>Try it now</button>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div className='absolute top-10 lg:left-36'>
                <div className='h-[500px] w-[500px] bg-sky-500 rounded-full  opacity-[0.1] blur-3xl'></div>
            </div>
        </div>
    );
};
